...
const (
	authToken    = "token"
	accountSid   = "AC81d44315e19273181bdaefac12cd3c12"
	serviceSid   = "IS83760ec293f6814bc6f5de5612f21fc2"
	workspaceSid = "WS645912e5aefc6727d71fe638c0173119"
	flexFlowSid  = "FObbde8f8e54f04afaef924046f728a44d"
)
...
func TestCreateFlexChannel(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "FObbde8f8e54f04afaef924046f728a44d", channel.FlexFlowSid)
	assert.Equal(t, "HTTP/1.0 201 Created\r\nContent-Length: 455\r\n\r\n", string(trace.ResponseTrace))
}
...
func TestCompleteTask(t *testing.T) {
	...
	httpx.SetRequestor(httpx.NewMockRequestor(map[string][]httpx.MockResponse{
		fmt.Sprintf("https://taskrouter.twilio.com/v1/Workspaces/%s/Tasks/%s", workspaceSid, taskSid): {
			...
			httpx.NewMockResponse(400, nil, `{
				"code": 20001,
				"message": "Cannot complete task WT1d187abc335f7f16ff050a66f9b6a6b2 in workspace WS645912e5aefc6727d71fe638c0173119 for account AC81d44315e19273181bdaefac12cd3c12 because it is not currently assigned.",
			...
			httpx.NewMockResponse(200, nil, `{
				...
				"account_sid": "AC81d44315e19273181bdaefac12cd3c12",
				"priority": 0,
				"url": "https://taskrouter.twilio.com/v1/Workspaces/WS645912e5aefc6727d71fe638c0173119/Tasks/WT1d187abc335f7f16ff050a66f9b6a6b2",
				"reason": "resolved",
				...
				"links": {
						"reservations": "https://taskrouter.twilio.com/v1/Workspaces/WS645912e5aefc6727d71fe638c0173119/Tasks/WT1d187abc335f7f16ff050a66f9b6a6b2/Reservations",
						"task_queue": "https://taskrouter.twilio.com/v1/Workspaces/WS645912e5aefc6727d71fe638c0173119/TaskQueues/WQa9e71cb17d52c8b75e4934b75e3297bc",
						"workspace": "https://taskrouter.twilio.com/v1/Workspaces/WS645912e5aefc6727d71fe638c0173119",
						"workflow": "https://taskrouter.twilio.com/v1/Workspaces/WS645912e5aefc6727d71fe638c0173119/Workflows/WWfaeaff148cfdefce03443a4980149558"
				}
			}`),
		},
	}))
	...
	_, _, err = client.CompleteTask(taskSid)
	assert.EqualError(t, err, "Cannot complete task WT1d187abc335f7f16ff050a66f9b6a6b2 in workspace WS645912e5aefc6727d71fe638c0173119 for account AC81d44315e19273181bdaefac12cd3c12 because it is not currently assigned.")
...
func TestFetchMedia(t *testing.T) {
	...
	defer httpx.SetRequestor(httpx.DefaultRequestor)
	httpx.SetRequestor(httpx.NewMockRequestor(map[string][]httpx.MockResponse{
		fmt.Sprintf("https://mcs.us1.twilio.com/v1/Services/IS83760ec293f6814bc6f5de5612f21fc2/Media/%s", mediaSid): {
			httpx.MockConnectionError,
			httpx.NewMockResponse(400, nil, `{"message": "Something went wrong", "detail": "Unknown", "code": 1234, "more_info": "https://www.twilio.com/docs/errors/1234"}`),
			httpx.NewMockResponse(200, nil, `{
				"sid": "ME59b872f1e52fbd6fe6ad956bbb4fa9bd",
